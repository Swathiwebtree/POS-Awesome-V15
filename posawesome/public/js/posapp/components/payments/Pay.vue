        ...
        <v-card class="main mx-auto bg-grey-lighten-5 mt-3 p-3 pb-16 overflow-y-auto"
          ...
          <div>
            ...
            <v-row align="center" no-gutters class="mb-1">
              <v-col md="4" cols="12">
                <v-select density="compact" variant="outlined" hide-details clearable :bg-color="isDarkTheme ? '#000' : 'white'" class="dark-field"
            ...
            <v-row align="center" no-gutters class="mb-1">
              <v-col md="4" cols="12" class="mr-1">
                <v-text-field density="compact" variant="outlined" color="primary" :label="frappe._('Search by Name')"
                  :bg-color="isDarkTheme ? '#000' : 'white'" class="dark-field" hide-details v-model="mpesa_search_name" clearable></v-text-field>
              </v-col>
              <v-col md="4" cols="12" class="mr-1">
                <v-text-field density="compact" variant="outlined" color="primary" :label="frappe._('Search by Mobile')"
                  :bg-color="isDarkTheme ? '#000' : 'white'" class="dark-field" hide-details v-model="mpesa_search_mobile" clearable></v-text-field>
              </v-col>
              <v-col> </v-col>
              <v-col md="3" cols="12">
        ...
        <v-card class="invoices mx-auto bg-grey-lighten-5 mt-3 p-3" style="max-height: 94vh; height: 94vh">
          <strong>
            ...
            <v-row>
              ...
              <v-col md="5">
                <v-text-field class="p-0 m-0" density="compact" color="primary" :bg-color="isDarkTheme ? '#000' : 'white'" class="dark-field" hide-details
              ...
              <v-row v-if="payment_methods.length" v-for="method in payment_methods" :key="method.row_id">
                ...
                <v-col md="5">
                  <div class="d-flex align-center">
                    ...
                    <v-text-field class="p-0 m-0" density="compact" color="primary" :bg-color="isDarkTheme ? '#000' : 'white'" class="dark-field"
