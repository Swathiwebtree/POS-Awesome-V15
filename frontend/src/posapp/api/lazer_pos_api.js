...
export const getVehicleDetails = (vehicle_no) => api.get("/get_vehicle_details", { params: { vehicle_no } });

// Get all service records for a vehicle
export const getServiceRecords = (vehicle_no) => api.get("/get_service_records", { params: { vehicle_no } });
