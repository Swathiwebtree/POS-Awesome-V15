                                        ...
                                        <v-row dense>
                                            <v-col cols="12" md="6" class="pr-md-2">
                                                <v-select :items="items_group" :label="__('Items Group')"
                                                    ...
                                                    @update:model-value="handleItemGroupUpdate"></v-select>
                                            </v-col>
                                            ...
                                            <v-col cols="12" md="6" class="pl-md-2"
                                                ...
                                                <v-text-field density="compact" variant="solo" color="primary"
                                                    :label="__('Price List')" :model-value="priceListToShow"
                                    ...
                                    <v-col cols="12" class="mt-2 mb-2">
                                        <v-row dense align="center">
                                            <v-col cols="12" sm="4" class="py-1">
                                                <v-btn size="small" block color="orange" variant="text"
                                                    @click="handleShowOffers" class="action-btn-consistent">
                                            ...
                                            <v-col cols="12" sm="4" class="py-1 text-right">
                                                <v-btn size="small" color="blue" variant="text"
                                                    @click="handleShowCoupons" class="action-btn-consistent">
