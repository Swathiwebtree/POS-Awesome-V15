...
const generateReport = async () => {
  try {
    const response = await axios.get("/api/method/posawesome.posawesome.api.lazer_pos.get_payment_summary_list", {
      params: {
...
.table-auto th, .table-auto td { padding:4px 6px; border:1px solid #ccc; text-align:left; }
</style>
