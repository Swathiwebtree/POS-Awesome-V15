<template>
	<div class="service-issue-note">
		...
		<div class="issue-form" v-if="showForm">
			...
			<div class="info-row">
				<label>ISN #:</label> <input v-model="isn" /> <label>Date:</label>
				<input type="date" v-model="date" /> <label>Loc:</label> <input v-model="loc" />
				<label>Station ID:</label> <input v-model="stationId" /> <label>Veh Reg #:</label>
				<input v-model="vehicleReg" /> <label>Mobile #:</label> <input v-model="mobile" />
				<label>Work Order #:</label> <input v-model="workOrder" /> <label>Sales Rep:</label>
				<input v-model="salesRep" /> <label>Lift Employee:</label> <input v-model="liftEmployee" />
