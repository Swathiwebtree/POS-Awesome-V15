...
const tabs = [
  { name: "MaterialRequest", label: "Material Request", component: () => import("./inventory/MaterialRequest.vue") },
  { name: "GoodsReceiptNote", label: "Goods Receipt Note", component: () => import("./inventory/GoodsReceiptNote.vue") },
  ...
  { name: "PhysicalCount", label: "Physical Count", component: () => import("./inventory/PhysicalCount.vue") },
  { name: "ProductionForm", label: "Production Form", component: () => import("./inventory/ProductionForm.vue") },
